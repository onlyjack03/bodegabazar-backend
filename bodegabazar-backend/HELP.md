...
* The original package name 'com.bodegabazar.bodegabazar-backend' is invalid and this project uses 'com.bodegabazar.bodegabazar_backend' instead.
...
* [Spring Boot Actuator](https://docs.spring.io/spring-boot/3.3.12/reference/actuator/index.html)
